"""
编写爬虫程序时，通常会构建一个UA池，就是将多个浏览器UA信息放入列表中在随机选择
构建用户代理池，避免总是使用一个UA访问网站
短时间内总使用一个UA高频率访问网站，可能会引起网站警觉，从而封杀IP
"""
...
ua_list = [
    ...
    'User-Agent:Opera/9.80 (Windows NT 6.1; U; en) Presto/2.8.131 Version/\
    11.11',
